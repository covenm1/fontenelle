    ...
    return (
      <footer>
        <div className="footer_top copy_container">
          <nav>
              <a className="social_fb" target="_blank" href="" >Facebook</a>
              <a className="social_tw" target="_blank" href="" >Twitter</a>
              <a className="social_ig" target="_blank" href="" >Instagram</a>
              <a className="social_yt" target="_blank" href="" >YouTube</a>
              <a className="social_fl" target="_blank" href="" >Flickr</a>
          </nav>
